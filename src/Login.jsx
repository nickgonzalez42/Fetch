      ...
      <form onSubmit={handleSubmit} className="login-form">
        <div className="flex-row">
          <label className="lf--label" htmlFor="name">
            <svg style={{ marginRight: "4px" }} x="0px" y="0px" width="12px" height="13px">
              <path
                fill="#B1B7C4"
          ...
          <input name="name" id="name" className="lf--input" placeholder="Full Name" type="text" />
        </div>
        <div className="flex-row">
          <label className="lf--label" htmlFor="email">
            <svg style={{ marginRight: "1px" }} x="0px" y="0px" width="15px" height="5px">
              <g>
                <path
                  fill="#B1B7C4"
          ...
          <input name="email" id="email" className="lf--input" placeholder="Email" type="email" />
        </div>
        <input style={{ float: "right" }} className="lf--submit" type="submit" value="LOGIN" />
      </form>
    </div>
  );
}
